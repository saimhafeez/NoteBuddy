...
export default function TaskSymbolSelectionModal({setModalVisible, onSymbolSelection}) {
                                ...
                                <View style={styles.popoverIconList}>
                                    {
                                        TaskSymbols.flags.map((data, index) => {
                                            return <TouchableOpacity key={index} onPress={() => onSymbolSelection(data)}>
                                                <MyIcon iconPack={data.iconPack} name={data.name} color={data.color} size={26} />
                                            </TouchableOpacity>
                                        })
                                    }
                                </View>
                                ...
                                <View style={styles.popoverIconList}>
                                    {
                                        TaskSymbols.progress.map((data, index) => {
                                            return <TouchableOpacity key={index} onPress={() => onSymbolSelection(data)}>
                                                <MyIcon key={index} iconPack={data.iconPack} name={data.name} color={data.color} size={26} />
                                            </TouchableOpacity>
                                        })
                                    }
                                </View>
